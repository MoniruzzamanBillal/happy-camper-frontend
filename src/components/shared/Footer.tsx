...
const Footer = () => {
  return (
    <footer className="bg-neutral-50 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left ">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between px-[6rem]">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 gap-y-14 align-middle px-[6rem] ">
          {/* <!-- Products section --> */}
          <div className="">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              mdmoniruzzamanbillal@gmail.com
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
